...
**KratosMultiphysics.AssignScalarFieldToElementsProcess** = class
AssignScalarFieldToElementsProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarFieldToElementsProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
