...
**KratosMultiphysics.CalculateEmbeddedNodalVariableFromSkinProcessArray** =
class
CalculateEmbeddedNodalVariableFromSkinProcessArray([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**Clear**(...)
    ...
    `Clear(self: Kratos.CalculateEmbeddedNodalVariableFromSkinProcessArray) -> None`

**__init__**(...)

    `__init__(self: Kratos.CalculateEmbeddedNodalVariableFromSkinProcessArray, arg0: Kratos::Model, arg1: Kratos::Parameters) -> None`
