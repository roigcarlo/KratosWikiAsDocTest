...
**KratosMultiphysics.StructuredMeshGeneratorProcess** = class
StructuredMeshGeneratorProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.StructuredMeshGeneratorProcess, arg0: Kratos::Geometry<Kratos::Node<3ul, Kratos::Dof<double> > >, arg1: Kratos.ModelPart, arg2: Kratos::Parameters) -> None`
