...
**KratosMultiphysics.SimpleMortarMapperProcess3D4N3NVector** = class
SimpleMortarMapperProcess3D4N3NVector([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**Map**(...)
    ...
    `Map(self: Kratos.SimpleMortarMapperProcess3D4N3NVector, arg0: Kratos.Array1DVariable3, arg1: Kratos.Array1DVariable3, arg2: Kratos.Flags) -> None`
