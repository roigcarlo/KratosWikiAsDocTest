...
**KratosMultiphysics.ResidualBasedAdjointStaticScheme** = class
ResidualBasedAdjointStaticScheme([Scheme](KratosMultiphysics.Scheme))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ResidualBasedAdjointStaticScheme, arg0: Kratos::AdjointResponseFunction) -> None`
