...
**KratosMultiphysics.FindElementalNeighboursProcess** = class
FindElementalNeighboursProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**ClearNeighbours**(...)
    ...
    `ClearNeighbours(self: Kratos.FindElementalNeighboursProcess) -> None`

**__init__**(...)

    `__init__(self: Kratos.FindElementalNeighboursProcess, arg0: Kratos.ModelPart, arg1: int, arg2: int) -> None`
