...
**KratosMultiphysics.AssignScalarVariableToNodesProcess** = class
AssignScalarVariableToNodesProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarVariableToNodesProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
