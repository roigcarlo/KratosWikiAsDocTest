...
**KratosMultiphysics.IterativeSolver** = class
IterativeSolver([LinearSolver](KratosMultiphysics.LinearSolver))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.IterativeSolver) -> None`

**__str__**(...)

    `__str__(self: Kratos.IterativeSolver) -> str`
