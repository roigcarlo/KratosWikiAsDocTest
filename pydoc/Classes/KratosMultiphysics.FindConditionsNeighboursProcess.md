...
**KratosMultiphysics.FindConditionsNeighboursProcess** = class
FindConditionsNeighboursProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**ClearNeighbours**(...)
    ...
    `ClearNeighbours(self: Kratos.FindConditionsNeighboursProcess) -> None`

**__init__**(...)

    `__init__(self: Kratos.FindConditionsNeighboursProcess, arg0: Kratos.ModelPart, arg1: int, arg2: int) -> None`
