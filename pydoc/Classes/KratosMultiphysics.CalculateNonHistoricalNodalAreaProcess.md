...
**KratosMultiphysics.CalculateNonHistoricalNodalAreaProcess** = class
CalculateNonHistoricalNodalAreaProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
1. __init__(self: Kratos.CalculateNonHistoricalNodalAreaProcess, arg0: Kratos.ModelPart) -> None  
  
2. __init__(self: Kratos.CalculateNonHistoricalNodalAreaProcess, arg0: Kratos.ModelPart, arg1: int) -> None`
