...
**KratosMultiphysics.SimpleMortarMapperProcess3D3NVector** = class
SimpleMortarMapperProcess3D3NVector([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**Map**(...)
    ...
    `Map(self: Kratos.SimpleMortarMapperProcess3D3NVector, arg0: Kratos.Array1DVariable3, arg1: Kratos.Array1DVariable3, arg2: Kratos.Flags) -> None`
