...
**KratosMultiphysics.ReorderAndOptimizeModelPartProcess** = class
ReorderAndOptimizeModelPartProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ReorderAndOptimizeModelPartProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
