...
**KratosMultiphysics.AssignScalarVariableToElementsProcess** = class
AssignScalarVariableToElementsProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarVariableToElementsProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
