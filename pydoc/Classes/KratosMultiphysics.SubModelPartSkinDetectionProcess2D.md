...
**KratosMultiphysics.SubModelPartSkinDetectionProcess2D** = class
SubModelPartSkinDetectionProcess2D([SkinDetectionProcess2D](KratosMultiphysics.SkinDetectionProcess2D))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.SubModelPartSkinDetectionProcess2D, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
