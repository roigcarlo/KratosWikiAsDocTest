...
**KratosMultiphysics.ApplyPeriodicConditionProcess** = class
ApplyPeriodicConditionProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ApplyPeriodicConditionProcess, arg0: Kratos.ModelPart, arg1: Kratos.ModelPart, arg2: Kratos::Parameters) -> None`
