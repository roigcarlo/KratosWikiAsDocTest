...
**KratosMultiphysics.AssignScalarFieldToConditionsProcess** = class
AssignScalarFieldToConditionsProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarFieldToConditionsProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
