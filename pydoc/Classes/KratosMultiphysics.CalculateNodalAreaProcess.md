...
**KratosMultiphysics.CalculateNodalAreaProcess** = class
CalculateNodalAreaProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
1. __init__(self: Kratos.CalculateNodalAreaProcess, arg0: Kratos.ModelPart) -> None  
  
2. __init__(self: Kratos.CalculateNodalAreaProcess, arg0: Kratos.ModelPart, arg1: int) -> None`
