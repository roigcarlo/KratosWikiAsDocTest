...
**KratosMultiphysics.FindNodalHNonHistoricalProcess** = class
FindNodalHNonHistoricalProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.FindNodalHNonHistoricalProcess, arg0: Kratos.ModelPart) -> None`
