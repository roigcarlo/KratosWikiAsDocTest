...
**KratosMultiphysics.FindNodalNeighboursProcess** = class
FindNodalNeighboursProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**ClearNeighbours**(...)
    ...
    `ClearNeighbours(self: Kratos.FindNodalNeighboursProcess) -> None`

**__init__**(...)

    `__init__(self: Kratos.FindNodalNeighboursProcess, arg0: Kratos.ModelPart, arg1: int, arg2: int) -> None`
