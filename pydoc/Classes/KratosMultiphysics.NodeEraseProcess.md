...
**KratosMultiphysics.NodeEraseProcess** = class
NodeEraseProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.NodeEraseProcess, arg0: Kratos.ModelPart) -> None`
