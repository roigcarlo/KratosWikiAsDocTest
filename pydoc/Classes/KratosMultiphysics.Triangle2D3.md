...
**KratosMultiphysics.Triangle2D3** = class
Triangle2D3([Geometry](KratosMultiphysics.Geometry))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.Triangle2D3, arg0: Kratos.Node, arg1: Kratos.Node, arg2: Kratos.Node) -> None`
