...
**KratosMultiphysics.ResidualBasedIncrementalUpdateStaticScheme** = class
ResidualBasedIncrementalUpdateStaticScheme([Scheme](KratosMultiphysics.Scheme))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ResidualBasedIncrementalUpdateStaticScheme) -> None`
