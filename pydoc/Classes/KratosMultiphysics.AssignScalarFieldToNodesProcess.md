...
**KratosMultiphysics.AssignScalarFieldToNodesProcess** = class
AssignScalarFieldToNodesProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarFieldToNodesProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
