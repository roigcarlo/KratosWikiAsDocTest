...
**KratosMultiphysics.ResidualBasedBDFCustomScheme** = class
ResidualBasedBDFCustomScheme([Scheme](KratosMultiphysics.Scheme))  
---  
`    `|   |

Method resolution order:

    [ResidualBasedBDFCustomScheme](KratosMultiphysics.ResidualBasedBDFCustomScheme)
...
1. __init__(self: Kratos.ResidualBasedBDFCustomScheme) -> None  
  
2. __init__(self: Kratos.ResidualBasedBDFCustomScheme, arg0: int) -> None  
  
3. __init__(self: Kratos.ResidualBasedBDFCustomScheme, arg0: int, arg1: Kratos::Parameters) -> None`
