...
**KratosMultiphysics.AssignScalarVariableToMasterSlaveConstraintsProcess** =
class
AssignScalarVariableToMasterSlaveConstraintsProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarVariableToMasterSlaveConstraintsProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
