...
**KratosMultiphysics.ResidualBasedIncrementalUpdateStaticSchemeSlip** = class
ResidualBasedIncrementalUpdateStaticSchemeSlip([ResidualBasedIncrementalUpdateStaticScheme](KratosMultiphysics.ResidualBasedIncrementalUpdateStaticScheme))  
---  
`    `|   |

Method resolution order:

    [ResidualBasedIncrementalUpdateStaticSchemeSlip](KratosMultiphysics.ResidualBasedIncrementalUpdateStaticSchemeSlip)
    [ResidualBasedIncrementalUpdateStaticScheme](KratosMultiphysics.ResidualBasedIncrementalUpdateStaticScheme)
...
1. __init__(self: Kratos.ResidualBasedIncrementalUpdateStaticSchemeSlip, arg0: int, arg1: int) -> None  
  
2. __init__(self: Kratos.ResidualBasedIncrementalUpdateStaticSchemeSlip, arg0: Kratos::CoordinateTransformationUtils<boost::numeric::ublas::matrix<double, boost::numeric::ublas::basic_row_major<unsigned long, long>, boost::numeric::ublas::unbounded_array<double, std::allocator<double> > >, boost::numeric::ublas::vector<double, boost::numeric::ublas::unbounded_array<double, std::allocator<double> > >, double>) -> None`
