...
**KratosMultiphysics.AssignScalarVariableToConditionsProcess** = class
AssignScalarVariableToConditionsProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.AssignScalarVariableToConditionsProcess, arg0: Kratos.ModelPart, arg1: Kratos::Parameters) -> None`
