...
**KratosMultiphysics.CalculateSignedDistanceTo3DConditionSkinProcess** = class
CalculateSignedDistanceTo3DConditionSkinProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.CalculateSignedDistanceTo3DConditionSkinProcess, arg0: Kratos.ModelPart, arg1: Kratos.ModelPart) -> None`
