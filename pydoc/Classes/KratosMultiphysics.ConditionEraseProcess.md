...
**KratosMultiphysics.ConditionEraseProcess** = class
ConditionEraseProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ConditionEraseProcess, arg0: Kratos.ModelPart) -> None`
