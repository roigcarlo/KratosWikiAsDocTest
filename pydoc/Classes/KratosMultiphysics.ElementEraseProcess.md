...
**KratosMultiphysics.ElementEraseProcess** = class
ElementEraseProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ElementEraseProcess, arg0: Kratos.ModelPart) -> None`
