...
**KratosMultiphysics.ResidualBasedAdjointSteadyScheme** = class
ResidualBasedAdjointSteadyScheme([ResidualBasedAdjointStaticScheme](KratosMultiphysics.ResidualBasedAdjointStaticScheme))  
---  
`    `|   |

Method resolution order:

    [ResidualBasedAdjointSteadyScheme](KratosMultiphysics.ResidualBasedAdjointSteadyScheme)
    [ResidualBasedAdjointStaticScheme](KratosMultiphysics.ResidualBasedAdjointStaticScheme)
...
**__init__**(...)
    ...
    `__init__(self: Kratos.ResidualBasedAdjointSteadyScheme, arg0: Kratos::AdjointResponseFunction) -> None`
