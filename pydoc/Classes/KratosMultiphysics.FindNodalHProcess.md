...
**KratosMultiphysics.FindNodalHProcess** = class
FindNodalHProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.FindNodalHProcess, arg0: Kratos.ModelPart) -> None`
