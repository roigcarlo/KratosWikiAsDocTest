...
**KratosMultiphysics.CheckSkinProcess** = class
CheckSkinProcess([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**__init__**(...)
    ...
    `__init__(self: Kratos.CheckSkinProcess, arg0: Kratos.ModelPart, arg1: Kratos.Flags) -> None`
