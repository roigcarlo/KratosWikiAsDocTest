...
**KratosMultiphysics.CalculateEmbeddedNodalVariableFromSkinProcessDouble** =
class
CalculateEmbeddedNodalVariableFromSkinProcessDouble([Process](KratosMultiphysics.Process))  
---  
`    `|   |
...
**Clear**(...)
    ...
    `Clear(self: Kratos.CalculateEmbeddedNodalVariableFromSkinProcessDouble) -> None`

**__init__**(...)

    `__init__(self: Kratos.CalculateEmbeddedNodalVariableFromSkinProcessDouble, arg0: Kratos::Model, arg1: Kratos::Parameters) -> None`
